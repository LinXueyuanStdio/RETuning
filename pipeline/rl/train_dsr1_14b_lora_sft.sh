...
pip install ray sphinx weave xlin deeplin math-verify mathruler nvitop
...
export WANDB_EXPERIMENT_NAME=DeepSeek-R1-14B-SFT-GRPO
export BASE_MODEL="/mnt/model/DeepSeek-R1-14B"
export SFT_OUTPUT_PATH="/mnt/data/runs/DeepSeek-R1-14B-SFT/sft_merge_output"
